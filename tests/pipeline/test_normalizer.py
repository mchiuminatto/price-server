...
from pipeline.steps.normalizer import NormalizerWorker, _normalize_tick, _normalize_ohlc
...
def test_normalize_ohlc_renames_columns():
    df = pd.DataFrame({
        ...
        "open_bid": [1.1], "high_bid_": [1.2], "low_bid": [1.0], "close_bid": [1.15],
        "volume_bis": [500],
        "open_ask": [1.101], "high_ask_": [1.201], "low_ask": [1.001],
        "close_ask": [1.151], "volume_ask": [500],
    })
